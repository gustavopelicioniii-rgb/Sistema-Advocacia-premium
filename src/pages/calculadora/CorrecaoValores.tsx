...
const CorrecaoValores = () => {
    ...
    const handleCalcular = async () => {
        ...
        const dIni = dataInicial.includes("/")
            ? `${dataInicial.slice(6)}-${dataInicial.slice(3, 5)}-${dataInicial.slice(0, 2)}`
            : dataInicial;
        const dFim = dataFinal.includes("/")
            ? `${dataFinal.slice(6)}-${dataFinal.slice(3, 5)}-${dataFinal.slice(0, 2)}`
            : dataFinal;
                        ...
                        <div className="grid gap-4 sm:grid-cols-2">
                            ...
                            <p className="text-sm">
                                ...
                                <strong className="text-primary">
                                    {formatCurrency(Number(resultado?.valorFinal) || 0)}
                                </strong>
                            </p>
                        </div>
